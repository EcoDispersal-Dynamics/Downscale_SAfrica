...
# ================================================================
# ESA_PLUM_Downscaled: deterministic_1.3 standalone runner
...
# - Fixed variant: kernel_radius = 1, synergy_table_id = 3
# ================================================================
...
build_synergy <- function(plum_layer_names, esa_classes) {
  allocations <- list(
    Cropland        = c("LC40" = 0.65, "LC20" = 0.20, "LC30" = 0.15),
    Pasture         = c("LC30" = 0.55, "LC20" = 0.30, "LC60" = 0.10, "LC10" = 0.05),
    TimberForest    = c("LC10" = 0.70, "LC20" = 0.20, "LC95" = 0.10),
    UnmanagedForest = c("LC10" = 0.75, "LC20" = 0.20, "LC95" = 0.05),
    OtherNatural    = c("LC20" = 0.40, "LC30" = 0.30, "LC90" = 0.20, "LC60" = 0.10),
    Barren          = c("LC60" = 0.85, "LC30" = 0.10, "LC100" = 0.03, "LC70" = 0.02),
    Urban           = c("LC50" = 0.95, "LC30" = 0.05)
  )
