...
# ================================================================
# ESA_PLUM_Downscaled: deterministic_2.2 standalone runner
...
# - Fixed variant: kernel_radius = 2, synergy_table_id = 2
# ================================================================
...
build_synergy <- function(plum_layer_names, esa_classes) {
  allocations <- list(
    Cropland        = c("LC40" = 0.71, "LC30" = 0.18, "LC20" = 0.06, "LC60" = 0.05),
    Pasture         = c("LC30" = 0.65, "LC20" = 0.18, "LC60" = 0.10, "LC40" = 0.07),
    TimberForest    = c("LC10" = 0.72, "LC20" = 0.16, "LC30" = 0.08, "LC95" = 0.04),
    UnmanagedForest = c("LC10" = 0.78, "LC20" = 0.14, "LC30" = 0.08),
    OtherNatural    = c("LC20" = 0.45, "LC30" = 0.30, "LC60" = 0.20, "LC90" = 0.05),
    Barren          = c("LC60" = 0.85, "LC30" = 0.10, "LC100" = 0.03, "LC70" = 0.02),
    Urban           = c("LC50" = 0.85, "LC30" = 0.10, "LC60" = 0.05)
  )
