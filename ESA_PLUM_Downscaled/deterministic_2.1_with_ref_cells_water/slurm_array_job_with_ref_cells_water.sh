#!/bin/bash
# SLURM array job script for ESA deterministic_2.1_with_ref_cells_water regions
...
echo "Running ESA deterministic_2.1_with_ref_cells_water: $SCENARIO region ${SLURM_ARRAY_TASK_ID}"
